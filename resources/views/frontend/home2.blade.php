<!DOCTYPE html>
	...
	<head>
		...
		<link rel="stylesheet" href="{{asset('assets/frontend/css/image.css')}}">
            ...
            <div class="container">
                <div class="navbar-header">
					...
					<h1 class="navbar-brand">
						...
						{{-- <a href="#body"><img src="{{asset('assets/frontend/img/logo.png')}}" height="40" width="164" alt=""></a> --}}
					</h1>
					<!-- /logo -->
                </div>
								...
								<ul id="mixed-items">
									<li class="mix category-1 col-md-4 col-xs-6" data-my-order="1">
										<a class="example-image-link" href="img/work1.jpg')}}" data-lightbox="example-set">
											<img class="img-responsive" src="{{asset('assets/frontend/img/work1.jpg')}}" alt="">
											<div class="overlay">
													<h3>Web design</h3>
									...
									<li class="mix category-2 col-md-4 col-xs-6" data-my-order="2">
										<a class="example-image-link" href="img/work2.jpg')}}" data-lightbox="example-set">
											<img class="img-responsive" src="{{asset('assets/frontend/img/work2.jpg')}}" alt="">
											<div class="overlay">
												<h3>Web design</h3>
												<i class="ion-ios-plus-empty"></i>
											</div>
									...
									<li class="mix category-1 col-md-4 col-xs-6" data-my-order="3">
										<a class="example-image-link" href="img/work3.jpg')}}" data-lightbox="example-set">
											<img class="img-responsive" src="{{asset('assets/frontend/img/work3.jpg')}}" alt="">
											<div class="overlay">
												<h3>Web design</h3>
												<i class="ion-ios-plus-empty"></i>
											</div>
									...
									<li class="mix category-2 col-md-4 col-xs-6" data-my-order="4">
										<a class="example-image-link" href="img/work4.jpg')}}" data-lightbox="example-set">
											<img class="img-responsive" src="{{asset('assets/frontend/img/work4.jpg')}}" alt="">
											<div class="overlay">
												<h3>Web design</h3>
												<i class="ion-ios-plus-empty"></i>
											</div>
									...
									<li class="mix category-1 col-md-4 col-xs-6" data-my-order="5">
										<a class="example-image-link" href="img/work5.jpg')}}" data-lightbox="example-set">
											<img class="img-responsive" src="{{asset('assets/frontend/img/work5.jpg')}}" alt="">
											<div class="overlay">
												<h3>Web design</h3>
												<i class="ion-ios-plus-empty"></i>
											</div>
									...
									<li class="mix category-2 col-md-4 col-xs-6" data-my-order="6">
										<a class="example-image-link" href="img/work6.jpg')}}" data-lightbox="example-set">
											<img class="img-responsive" src="{{asset('assets/frontend/img/work6.jpg')}}" alt="">
											<div class="overlay">
												<h3>Web design</h3>
												<i class="ion-ios-plus-empty"></i>
											</div>
				...
				<div class="row">
					...
					<div class="col-md-4 col-sm-4 col-xs-6">
						<div class="block wow fadeInLeft" data-wow-delay=".3s">
							<img src="{{asset('assets/frontend/img/team-img1.jpg')}}" alt="">
					...
					<div class="col-md-4  col-sm-4 col-xs-6">
						<div class="block wow fadeInLeft" data-wow-delay=".6s">
							<img src="{{asset('assets/frontend/img/team-img2.jpg')}}" alt="">
							<div class="team-overlay">
								<h3>ROBERT SMITH <span>Product Designer</span></h3>
								<span class="icon"><i class="ion-quote"></i></span>
								<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis</p>
					...
					<div class="col-md-4  col-sm-4 col-xs-6">
						<div class="block wow fadeInLeft" data-wow-delay=".9s">
							<img src="{{asset('assets/frontend/img/team-img3.jpg')}}" alt="">
							<div class="team-overlay">
								<h3>ROBERT SMITH <span>Product Designer</span></h3>
								<span class="icon"><i class="ion-quote"></i></span>
								<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis</p>
				...
				<div class="row">
					<div class="col-md-12">
						...
						<div id="blog-post" class="owl-carousel">
							<div>
								<div class="block">
									<img src="{{asset('assets/frontend/img/blog/blog-1.jpg')}}" alt="" class="img-responsive">
									<div class="content">
							...
							<div>
								<div class="block">
									<img src="{{asset('assets/frontend/img/blog/blog-2.jpg')}}" alt="" class="img-responsive">
									<div class="content">
										<h4><a href="blog.html">Hey,This is a blog title</a></h4>
										<small>By admin / Sept 18, 2014</small>
										<p>
							...
							<div>
								<div class="block">
									<img src="{{asset('assets/frontend/img/blog/blog-3.jpg')}}" alt="" class="img-responsive">
									<div class="content">
										<h4><a href="blog.html">Hey,This is a blog title</a></h4>
										<small>By admin / Sept 18, 2014</small>
										<p>
							...
							<div>
								<div class="block">
									<img src="{{asset('assets/frontend/img/blog/blog-4.jpg')}}" alt="" class="img-responsive">
									<div class="content">
										<h4><a href="blog.html">Hey,This is a blog title</a></h4>
										<small>By admin / Sept 18, 2014</small>
										<p>
					...
					<div class="col col-md-6">
						<div class="media wow fadeInLeft" data-wow-delay=".3s">
						  <div class="media-left">
						    <a href="#">
						      <img src="{{asset('assets/frontend/img/service-img.png')}}" alt="">
						    </a>
						  </div>
					...
					<div class="col-md-12">
						<div class="block">
							<div id="Client_Logo" class="owl-carousel">
								<div>
									<a href="#"><img class="img-responsive" src="{{asset('assets/frontend/img/clientLogo/client-logo1.jpg')}}" alt=""></a>
								</div>
								<div>
									<a href="#"><img class="img-responsive" src="{{asset('assets/frontend/img/clientLogo/client-logo2.jpg')}}" alt=""></a>
								</div>
								<div>
									<a href="#"><img class="img-responsive" src="{{asset('assets/frontend/img/clientLogo/client-logo3.jpg')}}" alt=""></a>
								</div>
								<div>
									<a href="#"><img class="img-responsive" src="{{asset('assets/frontend/img/clientLogo/client-logo4.jpg')}}" alt=""></a>
								</div>
								<div>
									<a href="#"><img class="img-responsive" src="{{asset('assets/frontend/img/clientLogo/client-logo5.jpg')}}" alt=""></a>
								</div>
								<div>
									<a href="#"><img class="img-responsive" src="{{asset('assets/frontend/img/clientLogo/client-logo6.jpg')}}" alt=""></a>
								</div>
								<div>
									<a href="#"><img class="img-responsive" src="{{asset('assets/frontend/img/clientLogo/client-logo1.jpg')}}" alt=""></a>
								</div>
