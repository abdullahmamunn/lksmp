                      ...
                      <div class="row">
                          <div class="col-sm-6">
                              <div class="form-group">
                                  ...
                                  <input type="text" id="name" name="name" value="" class="form-control" placeholder="Enter Menu Name" >
                              </div>
                          </div>
                          <div class="col-sm-6">
                              <div class="form-group {{ $errors->has('parent') ? 'has-error' : '' }}">
                                  ...
                                  <select id="parent" name="parent" class="form-control">
                                      ...
                                      <option value="{{$pm->parent }}"> {{$pm->name }} </option>
                                      @endforeach
                                  </select>
                              </div>
                          </div>
                          ...
                          <div class="col-sm-6">
                              <div class="form-group">
                                  ...
                                  <input type="text" id="url" name="url" class="form-control" placeholder="Enter Route Name">
                              </div>
                          </div>
                          <div class="col-sm-3">
                              <div class="form-group">
                          ...
                          <div class="col-sm-3">
                              <div class="form-group">
                                  ...
                                  <input type="number" id="sort" name="sort" class="form-control" placeholder="Enter Sort Number">
                              </div>
                          </div>
                          <div class="col-sm-3">
                              <div class="form-group">
